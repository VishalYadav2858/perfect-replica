...
const services = [
  ...
  },
  {
    ...
    link: "/3d-animation-and-cgi",
  },
  {
    title: "Photography",
    description: "We create content that speaks to your audience and solves for their needs — rooted in strategy, shaped by insight, and built to perform.",
