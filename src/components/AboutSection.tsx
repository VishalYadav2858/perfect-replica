...
const AboutSection = () => {
  return (
    <section className="py-24 md:py-36 px-6 lg:px-12 max-w-[1440px] mx-auto">
      ...
      >
        <h2 className="font-montserrat text-[40px] md:text-[60px] lg:text-[80px] font-[900] uppercase leading-[0.9] tracking-[-0.06em] text-foreground mb-10">
        ...
        <p className="font-montserrat text-[14px] md:text-[16px] font-[400] text-muted-foreground max-w-3xl leading-[1.8]">
          ...
          creators and businesses get the required task DONE. With a wide range of expertise, including content
          creation, brand development, performance marketing, website design and development, graphic
          design, photography, videography, we offer a comprehensive suite of
